...
<body>
  ...
  $query = "SELECT e.firstname, e.lastname, s.scheduledate, e.role, e.dateofbirth, e.emailaddress, SUM(TIMESTAMPDIFF(HOUR, s.starttime, s.endtime)) as total_hours_worked, COUNT(*) as num_infections
    FROM Employees e
  ...
  if ($result) {
    ...
    echo "<tr><th>First Name</th><th>Last Name</th><th>First Day Of Work</th><th>Role</th><th>Date Of Birth</th><th>Email Address</th><th>Total Hours Worked</th><th>Number Of Infections</th></tr>";
